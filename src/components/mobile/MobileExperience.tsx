...
function MobileLoading({ os, reducedMotion }: { os: MobileOS; reducedMotion: boolean }) {
  ...
  return <main className="mobile-android-boot"><AndroidMark className="android-boot-mark" /><strong>AmmarOS</strong><div className={`android-boot-dots ${reducedMotion ? 'still' : ''}`}><i /><i /><i /><i /></div><small>powered by <b>Android</b></small></main>
}
