...
import { BootSequence, LoadingScreen, WindowsSignIn, MacSignIn } from './components/BootSequence'
  ...
  return (
    <div className="app-root">
      ...
      <AnimatePresence mode="wait">
        ...
        {phase === 'mac-signin' && <motion.div key="mac-signin" className="phase-layer" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}><MacSignIn reducedMotion={reducedMotion} onSignIn={() => setPhase('desktop')} /></motion.div>}
